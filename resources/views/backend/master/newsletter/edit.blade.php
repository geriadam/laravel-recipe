...
@section('content')
    <div class="hk-pg-header">
        <h4 class="hk-pg-title"><span class="pg-title-icon"><i class="fa fa-users"></i></span></span>Edit Newsletter</h4>
    </div>

    <section class="hk-sec-wrapper">
        <div class="row">
            <div class="col-sm">
                {{ Form::open(['route' => ['backend.master.newsletter.update', $newsletter->id], 'files' => true, 'method' => 'PUT']) }}
                ...
                <div class="form-group">
                    ...
                    {!! Form::email('email', $newsletter->email, ["class" => "form-control"]) !!}
                </div>
                <hr>
                <div class="row">
                    <div class="col-sm-6">
